...
extern void PutChar_cn(unsigned char x,unsigned char y,unsigned short * GB);
extern void PutString_cn(unsigned char x,unsigned char y,unsigned short *p);
...
extern void Show_Char(unsigned char x,unsigned char y,unsigned char a,unsigned char type);
extern void Show_Short(unsigned char x,unsigned char y,unsigned short a,unsigned char type);
